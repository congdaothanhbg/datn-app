...
@section('main-content')
    ...
    <h1>Chỉnh sửa bài giảng</h1>
    <h2>Khoá học: <b>{{ $khoaHoc->ten_khoa_hoc }}</b></h2>
    <form method="POST" action="{{ route('khoa-hoc.bai-giang.update', [$khoaHoc, $baiGiang]) }}">
        @csrf
        @method('put')
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input id="thu_tu" type="number" name="thu_tu"
                        class="form-control @error('thu_tu') is-invalid @enderror" value="{{ $baiGiang->thu_tu }}" required
                        min="1">
                    @error('thu_tu')
                ...
                <div class="mb-3">
                    ...
                    <input id="ten_bai_giang" type="text" name="ten_bai_giang"
                        class="form-control @error('ten_bai_giang') is-invalid @enderror"
                        value="{{ $baiGiang->ten_bai_giang }}" required>
                    @error('ten_bai_giang')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea id="noi_dung" name="noi_dung" class="form-control @error('noi_dung') is-invalid @enderror" cols="30"
                        rows="10" required>{{ $baiGiang->noi_dung }}</textarea>
                    @error('noi_dung')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input id="thumbnail" class="form-control @error('hinh_anh') is-invalid @enderror" type="text"
                            name="hinh_anh" value="{{ $baiGiang->hinh_anh }}">
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn">
                            <a id="lfmVideo" data-input="video" data-preview="video" class="btn btn-primary text-white">
                                <i class="fa-solid fa-video"></i> Chọn
                            </a>
                        </span>
                        <input id="video" class="form-control @error('video') is-invalid @enderror" type="text"
                            name="video" value="{{ $baiGiang->video }}">
                    </div>
