    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="" class="active text-primary">Hồ sơ</a></li>
            </ul>
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="image">
                            @if ($profile->photo)
                                <img class="card-img-top img-fluid roundend-circle mt-4"
                                    ...
                                    src="{{ $profile->photo }}" alt="Ảnh đại diện">
                            @else
                                <img class="card-img-top img-fluid roundend-circle mt-4"
                                    style="border-radius:50%;height:80px;width:80px;margin:auto;"
                                    src="{{ asset('backend/img/avatar.png') }}" alt="Ảnh đại diện">
                            @endif
                        </div>
                        <div class="card-body mt-4 ml-2">
                            ...
                            <p class="card-text text-left">
                                <small class="text-muted">
                                    <i class="fas fa-hammer"></i>{{ $profile->role }}
                                </small>
                            </p>
                        </div>
                    </div>
